...
class ControladorUsuarios{
	...
	static public function ctrIngresoUsuario(){
		...
		if(isset($_POST["ingUsuario"])){
			...
			if(preg_match('/^[a-zA-Z0-9 *#]+$/', $_POST["ingUsuario"]) && preg_match('/^[a-zA-Z0-9 *#]+$/', $_POST["ingPassword"])){
				...
				$valor2 = $respuesta[0]["id_rol"];				

				$res = ModeloRoles::MdlMostrarRolesSesion($tabla2, $item2, $valor2);

				if($respuesta[0]["usuario_user"] == $_POST["ingUsuario"] && $respuesta[0]["password_user"] == $encriptar){
					...
					if($respuesta[0]["estado_user"] == 1){
						...
						$_SESSION["nombre_user"] = $respuesta[0]["nombre_user"];

						$_SESSION["usuario_user"] = $respuesta[0]["usuario_user"];

						$_SESSION["tipo_user"] = $res['nombre_rol'];

						$_SESSION["email_user"] = $respuesta[0]['email'];
						...
						if($ultimoLogin == "ok"){
							...
							if($_SESSION["tipo_user"] == 'General'){
								echo '<script>

									window.location = "tickets-user";

								</script>';
							} else if ($_SESSION["tipo_user"] == 'Técnico'){
								echo '<script>
	...
	static public function ctrCrearUsuarioVentana(){
