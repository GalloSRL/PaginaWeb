...
class ModeloMantenimientos{
	...
	static public function mdlIngresarMantenimiento($tabla, $datos){
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(fecha_realizada, sucursal, seccion, tipo_equipo, usuario, responsable_realizacion, nro_factura, detalle, referencia, proxima_revision) VALUES (:fecha_realizada, :sucursal, :seccion, :tipo_equipo, :usuario, :responsable_realizacion, :nro_factura, :detalle, :referencia, :proxima_revision)");
