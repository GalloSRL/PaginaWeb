                        ...
                        <div class="card-body">
                            ...
                            <div class="contenido">
                                <div class="responsive">
                                    <table id="tablaTickets" class="table table-hover table-striped responsive" width="100%">
                                        <thead>
                                            <tr>
                                                <th width="30px">#</th>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <span class="btn rounded-circle btn-success btn-sm btnVerTicket" idTicket="<?php echo $value['id'];?>" data-toggle="modal" data-target="#Ver" title="Verificar Registro"><i class="fas fa-tasks"></i></span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="nuevoTipoProblema" id="nuevoTipoProblema">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="nuevoSolicitadoPor" id="nuevoSolicitadoPor" required>
                                        <option value="">Seleccione una Opción</option>
                                        <?php
                                            $item = '';
                                            $valor = '';
                                ...
                                <input type="hidden" id="nuevoasignado" name="nuevoasignado" required>
                                <div class="form-group">
                                    <label for="">Asignado a:</label>
                                    <select class="form-control" name="nuevoAsignadoA" id="nuevoAsignadoA">
                                        <option value="">Seleccione una Opción</option>
                                        <?php
                                            $item = 'id_rol';
                                            $valor = 1;
                                        ...
                                        ?>
                                        <option value="Juan Barrios">Juan Barrios</option>
                                        <option value="Juan Martinez - José Portillo">Juan Martinez - José Portillo</option>    
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="">Sucursal:</label>
                                    <select class="form-control" name="nuevoIdSucursal" id="nuevoIdSucursal">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="">Tipo de Problema:</label>
                                    <select class="form-control" name="editarTipoProblema" id="editarTipoProblema">
                                        <option value="">Seleccione una Opción</option>
                                        <option value="SAP">SAP</option>
                                        <option value="Software">Software</option>
                                        <option value="Hardware">Hardware</option>
                                ...
                                <div class="form-group">
                                    <label for="">Prioridad del Trabajo:</label>
                                    <select class="form-control" name="editarPrioridad" id="editarPrioridad">
                                        <option value="">Seleccione una Prioridad</option>
                                        <option value="Alta">Alta</option>
                                        <option value="Media">Media</option>
                                        <option value="Baja">Baja</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Solicitado por:</label>
                                    <select class="form-control" name="editarSolicitadoPor" id="editarSolicitadoPor" required>
                                        <option value="">Seleccione una Opción</option>
                                        <?php
                                            $item = '';
                                            $valor = '';
                                ...
                                <input type="hidden" id="editarasignado" name="editarasignado" required>
                                <div class="form-group">
                                    <label for="">Asignado a:</label>
                                    <select class="form-control"  id="editarAsignadoA" name="editarAsignadoA">
                                        <option value="">Seleccione una Opción</option>
                                        <?php
                                            $item = 'id_rol';
                                            $valor = 1;
                                ...
                                <div class="form-group">
                                    <label for="">Sucursal:</label>
                                    <select class="form-control" name="editarIdSucursal" id="editarIdSucursal">
                                    <option value="">Seleccione una Sucursal</option>
                                    <option value="">Seleccione una Sucursal</option>
                                        <option value="2">Casa Matriz - Capiatá</option>
                                        <option value="3">Suc. 1 - Fdo. de la Mora</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="fechacierre" name="fechacierre" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <center>
                            <form target="_blank" action="vista/modulos/Reportes/ReporteGraficoTickets.php" method="POST">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control mb-2" name="year" id="year">
                                            ...
                                            <?php
                                                $item = null;
                                                $valor = null;
                                                $year = ControladorTickets::ctrAñoTickets($item, $valor);
                                        ...
                                        <select class="form-control" name="mes" id="mes" disabled="true">
                                            ...
                                            <?php
                                                $item = null;
                                                $valor = null;
                                                $mes = ControladorTickets::ctrMesTickets($item, $valor);
                                    ...
                                    <div class="btn-group">
                                        <span class="btn btn-primary btnVisualizarReporte"><i class="fas fa-eye"></i> Visualizar</span>
                                        <button type="submit" class="btn btn-danger btnPDF" disabled><i class="fas fa-file-pdf"></i> Generar PDF</button>
                                        <span type="reset" class="btn btn-secondary btnCerrarModal" data-dismiss="modal"><i class="fas fa-times"></i> Cancelar</span>
                                    </div>
                                </div>
                            </form>
                        </center>
                        ...
                        <div class="container">
                            ...
                            <div id="contenidoReporte" class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="au-card m-b-30">
                                        <div class="au-card-inner">
                                            <h3 class="title-2 m-b-40 text-bold text-center">Tickets por Persona Asignada</h3>
                                ...
                                <div class="col-lg-12">
                                    <div class="au-card m-b-30">
                                        <div class="au-card-inner">
                                            <h3 class="title-2 m-b-40 text-bold text-center">Tickets por Tipos de Problemas</h3>
