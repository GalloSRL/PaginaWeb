$(document).ready(function(){
    ...
    /*=============================================
    Obtener el nombre del usuario que solicita el ticket
    =============================================*/
    $('#nuevoAsignadoA').on('change', function(){
        var idUsuario = $('#nuevoAsignadoA').val();
        var datos = new FormData();
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(respuesta){
                $("#nuevoasignado").val(respuesta['nombre_user']);
            }
        });
    })
    ...
    /*=============================================
    Obtener el email del usuario que solicita el ticket
    =============================================*/
    ...
    /*=============================================
    Editar Obtener el nombre del usuario quien es asignado el ticket
    =============================================*/
    $('#editarAsignadoA').on('change', function(){
        var idUsuario = $('#editarAsignadoA').val();
        var datos = new FormData();
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(respuesta){
                $("#editarasignado").val(respuesta['nombre_user']);
            }
        });
    })
    ...
    $(document).on("click", ".btnEditarTicket", function(){
        ...
        $.ajax({
            ...
            success: function(respuesta){
                ...
                $("#editarTipoProblema").val(respuesta["tipo_problema"]);
                $("#editarPrioridad").val(respuesta["prioridad"]);
                $("#editarSolicitadoPor").val(respuesta["solicitado_por"]);
                $("#editarAsignadoA").val(respuesta["asignado_a"]);
    ...
    $(document).on("click", ".btnVerTicket", function(){
        ...
        $.ajax({
            ...
            success: function(respuesta){
                ...
                $("#fechaSolicitada").html(' '+fechaSolicitud);
                $("#problema").html(' '+respuesta['problema']);
                $("#problemaInput").val(respuesta['problema']);
                $("#tipoproblema").html(' '+respuesta['tipo_problema']);
                ...
                $("#asignadoa").html(' '+respuesta['asignado_a']);
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    success: function(respuesta){
                        $("#solicitadopor").html(' '+respuesta['nombre_user']);
